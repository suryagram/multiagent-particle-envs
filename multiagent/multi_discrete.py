...
import gym
# from gym.spaces import prng   # this prng has been cancelled
...
class MultiDiscrete(gym.Space):
    ...
    def sample(self):
        ...
        # random_array = prng.np_random.rand(self.num_discrete_space)  # This prng has been cancelled, using np.random instead
